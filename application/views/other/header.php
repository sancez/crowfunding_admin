    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                <img alt="image" src="<?php echo $foto_profil; ?>" class="user-img-radious-style">
                <span class="d-sm-none d-lg-inline-block"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right pullDown">
                <div class="dropdown-title">Hello <?php echo $userlogin->nama; ?></div>
                <a href="<?php echo base_url("user/edit_profil.html") ?>" class="dropdown-item has-icon">
                ...
                <a href="<?php echo base_url("/login/logout.html") ?>" class="dropdown-item has-icon text-danger">
