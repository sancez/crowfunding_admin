...
// ====================================================================================================================
	 ...
	 * @public static
	 */
	public static function UTF8StringToArray($str, &$currentfont,$isunicode=true) {
		if ($isunicode) {
	 ...
	 * @public static
	 */
	public static function UTF8ToLatin1($str, &$currentfont,$isunicode=true) {
	 ...
	 * @public static
	 */
	public static function UTF8ToUTF16BE($str, &$currentfont,$setbom=false, $isunicode=true) {
		if (!$isunicode) {
	 ...
	 * @public static
	 */
	public static function utf8StrRev($str, &$currentfont,$setbom=false, $forcertl=false, $isunicode=true) {
	 ...
	 * @public static
	 */
	public static function utf8StrArrRev($arr,&$currentfont,$str='', $setbom=false, $forcertl=false, $isunicode=true) {
	 ...
	 * @public static
	 */
	public static function utf8Bidi($ta, &$currentfont,$str='', $forcertl=false, $isunicode=true) {
