...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="light light-sidebar theme-white">
                        ...
                        <div class="row justify-content-center mt-0">
                            <div class="col-12 p-3 mt-3 mb-2">
                                <form id="msform" class="font-default form-properti" method="POST" action="/properti/ajax_properti">
                                        ...
                                        <div class="row ml-0 mr-0">
                                            <div class="col-12 mb-3 pl-4 pr-4 div-overflow-image-judul">
                                                <div class="row row-image-judul">
                                                    ...
                                                    <?php 
                                                        foreach (json_decode($properti->foto) as $item) {
                                                            ?>
                                                                <div class="div-image-judul div-image-data d-inline m-2" style="background-image: url('<?php echo $this->config->item("cdn_url"); ?>/<?php echo $item; ?>'); background-size: cover; background-position: center center;">
                                                                    <a class="btn btn-danger btn-delete-image text-white"><i class="fa fa-times"></i></a>
                                                                    <input type="hidden" class="data-foto" value="<?php echo $item; ?>">
                                                                </div>
                                                            <?php
                                                        }
                                                    ?>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" readonly class="form-control jumlah-dana text-right" placeholder="Jumlah Dana" maxlength="19" name="form[jumlah_dana]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->jumlah_dana); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="form-control-label text-dark">Harga Saham</label>
                                                    <input type="text" class="form-control harga-per-lembar text-right" placeholder="Harga Saham" maxlength="19" name="form[harga_per_lembar]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->harga_per_lembar); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label class="form-control-label text-dark">Total Saham</label>
                                                    <input type="text" class="form-control total-per-lembar text-right" placeholder="Total Saham" maxlength="19" name="form[total_per_lembar]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->total_per_lembar); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="number" class="form-control" placeholder="ROI" name="form[roi]" value="<?php echo $properti->roi; ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Lepas Saham</label>
                                                            <div class="input-group">
                                                                <input type="number" class="form-control" placeholder="Lepas Saham" name="form[lepas_saham]" value="<?php echo $properti->lepas_saham; ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text">%</span>
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="row ml-0 mr-0">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Nama Projek" maxlength="100" name="form[nama]" value="<?php echo $properti->nama; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-control-label text-dark">Latitude</label>
                                                    <input type="text" class="form-control" placeholder="Latitude" maxlength="25" name="form[latitude]" value="<?php echo explode(", ",$properti->latitude_longitude)[0]; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-control-label text-dark">Longitude</label>
                                                    <input type="text" class="form-control" placeholder="Longitude" maxlength="25" name="form[longitude]" value="<?php echo explode(", ",$properti->latitude_longitude)[1]; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-control-label text-dark">Alamat</label>
                                                    <textarea type="text" class="form-control input-uppercase" placeholder="Alamat" maxlength="150" name="form[alamat]" style="height: 60px;"><?php echo $properti->alamat; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="mt-repeater-deskripsi mt-repeater-group">
                                                        <table class="table table-striped table-bordered">
                                                            ...
                                                            <tbody data-repeater-list="form[repeater_deskripsi]" id="mt-repeater-tbody-deskripsi">
                                                                <?php 
                                                                    foreach (json_decode($properti->overview) as $item) {
                                                                        ?>
                                                                            <tr data-repeater-item class="mt-repeater-item">
                                                                                <td>
                                                                                    <div class="mt-repeater-input">
                                                                                        <input required type="text" class="form-control" placeholder="Deskripsi" value="<?php echo $item; ?>">
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                                    <center>
                                                                    ...
                                                                    if(count(json_decode($properti->overview)) == 0){
                                                                        ?>
                                                                        <tr data-repeater-item class="mt-repeater-item">
                                                                            <td>
                                                                                <div class="mt-repeater-input">
                                                        ...
                                                        <?php 
                                                            foreach ($dokumen as $item) {
                                                                ?>
                                                                    <tr>
                                                                        <td>
                                                                            <a class="bold text-info" onclick="window.open('<?php echo $this->config->item("cdn_url"); ?>/file_upload/<?php echo $item->file; ?>', '', 'width=800,height=400');"><?php echo $item->nama; ?></a>&nbsp;&nbsp;&nbsp;<a class="bold text-danger btn-delete-dokumen"><i class="fa fa-times"></i></a>
                                                                        </td>
                                                                        <td>
                                                                            <?php if(isset($item->keterangan)) echo $item->keterangan; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo date("d M Y H:i:s", strtotime($item->created_at)); ?>
                                                                            <input type="hidden" class="dokumen-nama" value="<?php echo $item->nama; ?>">
                                                                            <input type="hidden" class="dokumen-file" value="<?php echo $item->file; ?>">
                                                                            <input type="hidden" class="dokumen-keterangan" value="<?php if(isset($item->keterangan)) echo $item->keterangan; ?>">
                                                                            <input type="hidden" class="dokumen-created-at" value="<?php echo $item->created_at; ?>">
                                                                        </td>
                                                                    </tr>
                                                                <?php
                                                            }
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                            foreach ($grafik as $item) {
                                                                $foto_data_url = "";
                                                                if($item->foto != ""){
                                                                    $foto_data_url = "<a class='bold text-info' onclick='OpenImage(".'"'.$this->config->item("cdn_url")."/file_upload/".$item->foto.'"'.");'><i style='font-size: 30px;' class='fa fa-image'></i></a>";
                                                                }
                                                                $earlier = new DateTime($item->tgl_mulai);
                                                                $later = new DateTime($item->tgl_selesai);
                                                                $abs_diff = $later->diff($earlier)->format("%a")+1;
                                                                ?>
                                                                    <tr>
                                                                        <td style="width:10px;"><?php echo $foto_data_url; ?></td>
                                                                        <td><a class="bold text-info edit-keterangan"><?php echo $item->keterangan; ?></a>&nbsp;&nbsp;&nbsp;<a class="bold text-danger btn-delete-grafik-progress"><i class="fa fa-times"></i></a></td>
                                                                        <td class="text-center"><?php echo date("d M Y", strtotime($item->tgl_mulai)); ?></td>
                                                                        <td class="text-center"><?php echo date("d M Y", strtotime($item->tgl_selesai)); ?></td>
                                                                        <td class="text-center"><?php echo $abs_diff; ?> hari</td>
                                                                        <td class="text-center">
                                                                            <div class="progress" style="height: 17px;">
                                                                                <div class="progress-bar" style="width: <?php echo $item->progress; ?>%;"><?php echo $item->progress; ?>%</div>
                                                                            </div>
                                                                            <input type="hidden" class="progress-foto" value="<?php echo $item->foto; ?>">
                                                                            <input type="hidden" class="progress-keterangan" value="<?php echo $item->keterangan; ?>">
                                                                            <input type="hidden" class="progress-tgl-mulai" value="<?php echo $item->tgl_mulai; ?>">
                                                                            <input type="hidden" class="progress-tgl-selesai" value="<?php echo $item->tgl_selesai; ?>">
                                                                            <input type="hidden" class="progress-progress" value="<?php echo $item->progress; ?>">
                                                                        </td>
                                                                    </tr>
                                                                <?php
                                                            }
                                    ...
                                    <input type="hidden" class="id_hidden" name="form[id]" value="<?php echo $properti->id; ?>">
                                </form>
                            </div>
                        </div>
                    </section>
        ...
        <script>
            $("select[name='form[dividen_period]']").val("<?php echo $properti->dividen_period; ?>").trigger("change");
            $("select[name='form[tipe_aset]']").val("<?php echo $properti->tipe_aset; ?>").trigger("change");
            var html_tag_delete = "";
            var html_tag_gambar = "";
            GetDropdownLokasi("<?php echo $properti->id_lokasi; ?>");
            GetDropdownPenerbit("<?php echo $properti->id_penerbit; ?>");
            var post_gambar  = {"form": {"Base64": ""}};
            initMap();
            var latitude_longitude = "<?php echo $properti->latitude_longitude; ?>";
            let markers = [];
            function initMap() {
                const map = new google.maps.Map(document.getElementById("map"), {
                    zoom: 11,
                    center: { lat: <?php echo explode(", ",$properti->latitude_longitude)[0]; ?>, lng: <?php echo explode(", ",$properti->latitude_longitude)[1]; ?> },
                });
                ...
                setTimeout(function(){
                    const latlng_first = {
                        lat: parseFloat("<?php echo explode(", ",$properti->latitude_longitude)[0]; ?>"),
                        lng: parseFloat("<?php echo explode(", ",$properti->latitude_longitude)[1]; ?>"),
                    };
            ...
            <?php
                if(count(json_decode($properti->foto)) >= (int)$maksimal_foto_properti){
                    echo "$('.div-image-tambah').addClass('d-none').removeClass('d-inline');";
                }
            ?>
            ...
            $(".mt-repeater-deskripsi").each(function(){
                $(this).repeater({
                    show: function () {
                        $(this).slideDown();
                        $(".mt-repeater-deskripsi").find("tr:last-child").find("input").val("");
                    },
