<div class="modal fade" id="modal-edit-manajemen-investor" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h5 class="modal-title text-white">Manajemen Investor : Nama</h5>
                        ...
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-1" name="form[nama_lengkap]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-2" name="form[email]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-3" name="form[no_telefon]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-4" name="form[jenis_kelamin]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-22" name="form[data_nik]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-23" name="form[data_npwp]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-5" name="form[tgl_lahir]" value="1" type="checkbox">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-6" name="form[status_pernikahan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-7" name="form[pekerjaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-8" name="form[sumber_penghasilan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-9" name="form[pendapatan_pertahun]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-10" name="form[nama_pemilik_rekening]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-11" name="form[nama_cabang_bank]" value="1" type="checkbox">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-12" name="form[nama_bank]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-24" name="form[provinsi]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-13" name="form[kota]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-14" name="form[kecamatan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-15" name="form[kelurahan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-16" name="form[alamat_lengkap]" value="1" type="checkbox">
                        ...
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-17" name="form[ktp]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-18" name="form[selfie_ktp]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-19" name="form[npwp]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-20" name="form[selfie_npwp]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabled id="input-group-21" name="form[buku_tabungan]" value="1" type="checkbox">
