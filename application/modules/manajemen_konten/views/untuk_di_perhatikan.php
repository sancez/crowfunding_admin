    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="edit"></i><span>&nbsp;&nbsp;Footer</span></h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <button type="button" class="btn btn-info ladda-button ladda-button-submit after-loading d-none" data-style="slide-up" onclick="SimpanEditUntukDiPerhatikan();"><i class="fa fa-save"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <form id="FrmEditUntukDiPerhatikan" class="form-horizontal form-untuk-di-perhatikan-edit" role="form" method="POST" action="/manajemen_konten/ajax_manajemen_konten_untuk_di_perhatikan">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="after-loading d-none">
                                                        ...
                                                        <div id="summernote-untuk-di-perhatikan"></div>
        ...
        <script>
            $(document).ready(function(){
                pagename = "/manajemen_konten/ajax_manajemen_konten_untuk_di_perhatikan";
                GetDataById("", function(resp) {
                    ...
                    $("#summernote-untuk-di-perhatikan").html(resp_summernote);
                    $("#summernote-untuk-di-perhatikan").summernote({
                        placeholder: "Untuk di Perhatikan",
                        tabsize: 2,
                        height: 500,
            ...
            function SimpanEditUntukDiPerhatikan(){
                var data_summernote_value = $("#summernote-untuk-di-perhatikan").parent().find(".note-editable").html();
                $("input[name='form[value]']").val(data_summernote_value);
                $("#FrmEditUntukDiPerhatikan").submit();
            }

            var FrmEditUntukDiPerhatikan = $("#FrmEditUntukDiPerhatikan").validate({
