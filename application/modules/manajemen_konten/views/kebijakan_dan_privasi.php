...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <title>Kebijakan dan Privasi</title>
    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="edit"></i><span>&nbsp;&nbsp;Kebijakan dan Privasi</span></h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <button type="button" class="btn btn-info ladda-button ladda-button-submit after-loading d-none" data-style="slide-up" onclick="SimpanEditKebijakanDanPrivasi();"><i class="fa fa-save"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <form id="FrmEditKebijakanDanPrivasi" class="form-horizontal form-kebijakan-dan-privasi-edit" role="form" method="POST" action="/manajemen_konten/ajax_manajemen_konten_kebijakan_dan_privasi">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="after-loading d-none">
                                                        ...
                                                        <div id="summernote-kebijakan-dan-privasi"></div>
        ...
        <script>
            $(document).ready(function(){
                pagename = "/manajemen_konten/ajax_manajemen_konten_kebijakan_dan_privasi";
                GetDataById("", function(resp) {
                    ...
                    $("#summernote-kebijakan-dan-privasi").html(resp_summernote);
                    $("#summernote-kebijakan-dan-privasi").summernote({
                        placeholder: "Kebijakan dan Privasi",
                        tabsize: 2,
                        height: 500,
            ...
            function SimpanEditKebijakanDanPrivasi(){
                var data_summernote_value = $("#summernote-kebijakan-dan-privasi").parent().find(".note-editable").html();
                $("input[name='form[value]']").val(data_summernote_value);
                $("#FrmEditKebijakanDanPrivasi").submit();
            }

            var FrmEditKebijakanDanPrivasi = $("#FrmEditKebijakanDanPrivasi").validate({
