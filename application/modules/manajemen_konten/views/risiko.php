    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="edit"></i><span>&nbsp;&nbsp;Risiko</span></h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <button type="button" class="btn btn-info ladda-button ladda-button-submit after-loading d-none" data-style="slide-up" onclick="SimpanEditRisiko();"><i class="fa fa-save"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <form id="FrmEditRisiko" class="form-horizontal form-risiko-edit" role="form" method="POST" action="/manajemen_konten/ajax_manajemen_konten_risiko">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
        ...
        <script>
            $(document).ready(function(){
                pagename = "/manajemen_konten/ajax_manajemen_konten_risiko";
                GetDataById("", function(resp) {
                    ...
                    $("#summernote-risiko").html(resp_summernote);
                    $("#summernote-risiko").summernote({
                        placeholder: "Risiko",
                        tabsize: 2,
                        height: 500,
            ...
            function SimpanEditRisiko(){
                var data_summernote_value = $("#summernote-risiko").parent().find(".note-editable").html();
                $("input[name='form[value]']").val(data_summernote_value);
                $("#FrmEditRisiko").submit();
            }

            var FrmEditRisiko = $("#FrmEditRisiko").validate({
