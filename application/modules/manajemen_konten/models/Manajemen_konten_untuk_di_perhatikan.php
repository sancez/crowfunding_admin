<?php
	...
	class Manajemen_konten_untuk_di_perhatikan extends CI_Model {
	    ...
	    public function GetManajemenKontenUntukDiPerhatikan(){
			$this->db->where("name", "Untuk di Perhatikan");
			$return_data["data"] = $this->db->get("tb_setting")->result();
			return $return_data;
		}

        public function UpdateManajemenKontenUntukDiPerhatikan($param) {
