<?php
	...
	class Manajemen_konten_syarat_dan_ketentuan extends CI_Model {
	    ...
	    public function GetManajemenKontenSyaratDanKetentuan(){
			$this->db->where("name", "Syarat dan Ketentuan");
			$return_data["data"] = $this->db->get("tb_setting")->result();
			return $return_data;
		}

        public function UpdateManajemenKontenSyaratDanKetentuan($param) {
