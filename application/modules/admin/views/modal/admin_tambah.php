<div class="modal fade" id="modal-tambah-admin" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="FrmTambahAdmin" class="form-horizontal form-admin-baru" role="form" method="POST" action="/admin/ajax_admin">
                    <div class="row">
                        <div class="col-lg-6">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info ladda-button ladda-button-submit" onclick="SimpanTambahAdmin();" data-style="slide-up">Simpan</button>
            </div>
        </div>
    </div>
</div>