    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="database"></i>&nbsp;&nbsp;Log Penerbit</h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <div class="btn-group pagination-layout-log-penerbit" pagename="/log/ajax_log_penerbit" data-colspan="4" role="group" aria-label="Basic example">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable-log-penerbit table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Penerbit</th>
                                    ...
                                    <div class="card-footer div-pagination-bottom">
                                        <div class="pagination-layout-log-penerbit d-none" pagename="/log/ajax_log_penerbit" data-colspan="4">
                                            <div class="row">
        ...
        <script>
            ...
            function GetDataTable(){
                ...
                request["Sort"] = sort;
                request["Search"] = kywd;
                pagename = "/log/ajax_log_penerbit";
                target_table = "log-penerbit";
