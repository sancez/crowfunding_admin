<div class="modal fade" id="modal-edit-manajemen-penerbit" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h5 class="modal-title text-white">Manajemen Penerbit : Nama</h5>
                        ...
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-1" name="form[nama_perusahaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-2" name="form[email]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-3" name="form[data_npwp_perusahaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-4" name="form[nama_penanggung_jawab]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-5" name="form[nik_penanggung_jawab]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-6" name="form[provinsi]" value="1" type="checkbox">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-7" name="form[kota]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-8" name="form[no_telepon]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-9" name="form[kecamatan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-10" name="form[kelurahan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-11" name="form[alamat_lengkap]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-12" name="form[jabatan]" value="1" type="checkbox">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-13" name="form[nomor_rekening_perusahaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-14" name="form[nama_pemilik_rekening_bank]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-15" name="form[nama_bank]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-16" name="form[nama_cabang_bank]" value="1" type="checkbox">
                        ...
                        <div class="card">
                            <div class="card-body row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-17" name="form[siup]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-18" name="form[nib]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-19" name="form[npwp_perusahaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-20" name="form[ktp_penanggung_jawab]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-21" name="form[ktp_direksi]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-22" name="form[ktp_komisaris]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-23" name="form[akta_pendirian_perusahaan]" value="1" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroup">
                                            <input disabledid="input-group-24" name="form[akta_perubahan_anggaran_dasar_terakhir]" value="1" type="checkbox">
