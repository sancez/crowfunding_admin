<?php
	...
	class Manajemen_transaksi_biaya_admin extends CI_Model {
	    ...
	    public function GetManajemenTransaksiBiayaAdmin($param, $disable_page=false){
			$args["search"] = "";
            $return_data["data"] = "";
		...
		public function HtmlManajemenTransaksiBiayaAdmin($param){
		    $rHtml ="";
			$query = $this->GetManajemenTransaksiBiayaAdmin($param);
			if(!empty($query["data"])) {
				foreach ($query["data"] as $item) {
                    ...
                    $rHtml .= "<tr>
								    ...
								    <td class='text-right'>".$this->foglobal->rupiah($item->biaya_administrasi, false, true)."</td>
