...
<html class="loading" lang="en" data-textdirection="ltr">
    <head>
        ...
        <title>pembelian saham (primary)</title>
    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="trending-up"></i>&nbsp;&nbsp;pembelian saham (primary)</h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <div class="btn-group pagination-layout-manajemen-transaksi-jual-beli" pagename="/manajemen_transaksi/ajax_manajemen_transaksi_jual_beli" data-colspan="8" role="group" aria-label="Basic example">
                                ...
                                <div class="form-group float-right div-header-search">
                                    <form id="FrmSearch">
                                        <div class="input-group input-search">
                                            <input type="text" class="form-control kywd" placeholder="Cari (No Transaksi, Investor, Properti, Perusahaan)" title="Cari (No Transaksi, Investor, Properti, Perusahaan)" aria-describedby="basic-addon2">
                            ...
                            <div class="col-12">
                                <div class="card">
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select style="width: 100%;" class="form-control select sort">
                                                            ...
                                                            <option value="no_transaksi asc">No Transaksi [A-Z]</option>
                                                            <option value="no_transaksi desc">No Transaksi [Z-A]</option>
                                                            <option value="total_transaksi asc">Total Pembayaran [A-Z]</option>
                                                            <option value="total_transaksi desc">Total Pembayaran [Z-A]</option>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table datatable-manajemen-transaksi-jual-beli table-striped table-bordered">
                                            <thead>
                                                <tr>
                                    ...
                                    <div class="card-footer div-pagination-bottom">
                                        <div class="pagination-layout-manajemen-transaksi-jual-beli d-none" pagename="/manajemen_transaksi/ajax_manajemen_transaksi_jual_beli" data-colspan="8">
                                            <div class="row">
        ...
        <?php $this->load->view("manajemen_transaksi/modal/manajemen_transaksi_jual_beli_detail"); ?>
        ...
        <script>
            ...
            function GetDataTable(){
                ...
                pagename = "/manajemen_transaksi/ajax_manajemen_transaksi_jual_beli";
                target_table = "manajemen-transaksi-jual-beli";
            ...
            var manajemen_transaksi_jual_beli_detail = $("#modal-detail-manajemen-transaksi-jual-beli");
            $(".datatable-manajemen-transaksi-jual-beli").on("click", ".detail-manajemen-transaksi-jual-beli", function() {
                $("#modal-detail-manajemen-transaksi-jual-beli .modal-title").text("Detail Transaksi : Transaksi");
                manajemen_transaksi_jual_beli_detail.find(".loading-gif-image").removeClass("d-none");
                manajemen_transaksi_jual_beli_detail.find(".after-loading").addClass("d-none");
                $("#modal-detail-manajemen-transaksi-jual-beli").modal("show");
                var id_update = $(this).attr("data-id");
                pagename = "/manajemen_transaksi/ajax_manajemen_transaksi_jual_beli";
                GetDataById(id_update, function(resp) {
                    var resp = resp.data[0];
                    manajemen_transaksi_jual_beli_detail.find(".nama-properti").text(resp.nama_properti);
                    manajemen_transaksi_jual_beli_detail.find(".alamat").text(resp.alamat_properti);
                    manajemen_transaksi_jual_beli_detail.find(".durasi-proyek").text(moment(resp.tgl_mulai).format("DD MMM YYYY")+" - "+moment(resp.tgl_selesai).format("DD MMM YYYY"));
                    manajemen_transaksi_jual_beli_detail.find(".harga-saham").text("Rp "+rupiah(resp.harga_per_lembar));
                    manajemen_transaksi_jual_beli_detail.find(".jumlah-saham").text("Rp "+rupiah(resp.jumlah_dana));
                    manajemen_transaksi_jual_beli_detail.find(".dividen-period").text(resp.dividen_period);
                    manajemen_transaksi_jual_beli_detail.find(".no-transaksi").text(resp.no_transaksi);
                    manajemen_transaksi_jual_beli_detail.find(".tgl-transaksi").text(moment(resp.tgl_transaksi).format("DD MMM YYYY HH:mm:ss"));
                    manajemen_transaksi_jual_beli_detail.find(".biaya-administrasi").text("Rp "+rupiah(resp.biaya_administrasi));
                    manajemen_transaksi_jual_beli_detail.find(".total-pembayaran").text("Rp "+rupiah(resp.total_transaksi));
                    manajemen_transaksi_jual_beli_detail.find(".loading-gif-image").addClass("d-none");
                    manajemen_transaksi_jual_beli_detail.find(".after-loading").removeClass("d-none");
                    $("#modal-detail-manajemen-transaksi-jual-beli .modal-title").text("Detail Transaksi : " + resp.no_transaksi);
                });
            });

            $(".btn-pdf").click(function(){
                var kywd = $("#FrmSearch").find(".kywd").val(), status_verifikasi = $("#FrmFilter").find(".status-verifikasi").val(), sort = $("#FrmFilter").find(".sort").val(), tanggal_periode = $("#FrmFilter").find(".tanggal").val();
                window.location.href = base_url + "/manajemen_transaksi/jual_beli_cetak.html?sort="+sort+"&search="+kywd+"&status="+status_verifikasi+"&tanggal_mulai="+moment(tanggal_periode.slice(0, 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&tanggal_selesai="+moment(tanggal_periode.substr(tanggal_periode.length - 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&by="+"<?php echo $this->session->userdata("user")->nama; ?>";
            });
            $(".btn-excel").click(function(){
                var kywd = $("#FrmSearch").find(".kywd").val(), status_verifikasi = $("#FrmFilter").find(".status-verifikasi").val(), sort = $("#FrmFilter").find(".sort").val(), tanggal_periode = $("#FrmFilter").find(".tanggal").val();
                window.location.href = base_url + "/manajemen_transaksi/jual_beli_excel.html?sort="+sort+"&search="+kywd+"&status="+status_verifikasi+"&tanggal_mulai="+moment(tanggal_periode.slice(0, 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&tanggal_selesai="+moment(tanggal_periode.substr(tanggal_periode.length - 11), "DD MMM YYYY").format("YYYY-MM-DD");
            });
        </script>
    </body>
</html>
