...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body class="light light-sidebar theme-white">
                    ...
                    <section class="section">
                        <div class="row">
                            <div class="content-header-left col-md-4 col-12 mb-2">
                                <h4 class="content-header-title">&nbsp;<i data-feather="trending-up"></i>&nbsp;&nbsp;Isi Saldo</h4>
                            </div>
                            <div class="content-header-right col-md-8 col-12">
                                <div class="form-group float-right div-header-button">
                                    ...
                                    <div class="btn-group pagination-layout-manajemen-transaksi-biaya-admin" pagename="/manajemen_transaksi/ajax_manajemen_transaksi_isi_saldo" data-colspan="8" role="group" aria-label="Basic example">
                                ...
                                <div class="form-group float-right div-header-search">
                                    <form id="FrmSearch">
                                        <div class="input-group input-search">
                                            <input type="text" class="form-control kywd" placeholder="Cari (No Transaksi, Virtual Account, Investor, Keterangan)" title="Cari (No Transaksi, Virtual Account, Investor, Keterangan)" aria-describedby="basic-addon2">
                            ...
                            <div class="col-12">
                                <div class="card">
                                            ...
                                            <div class="panel-body row">
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <select style="width: 100%;" class="form-control select status">
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select style="width: 100%;" class="form-control select sort">
                                                            ...
                                                            <option value="nominal asc">Nominal [A-Z]</option>
                                                            <option value="nominal desc">Nominal [Z-A]</option>
                                    ...
                                    <div class="card-footer div-pagination-bottom">
                                        <div class="pagination-layout-manajemen-transaksi-biaya-admin d-none" pagename="/manajemen_transaksi/ajax_manajemen_transaksi_isi_saldo" data-colspan="8">
                                            <div class="row">
        ...
        <?php // $this->load->view("manajemen_transaksi/modal/manajemen_transaksi_isi_saldo_detail"); ?>
        ...
        <script>
            ...
            function GetDataTable(){
                var kywd = $("#FrmSearch").find(".kywd").val(), status = $("#FrmFilter").find(".status").val(), sort = $("#FrmFilter").find(".sort").val(), tanggal_periode = $("#FrmFilter").find(".tanggal").val();
                request["Page"] = 1;
                request["Sort"] = sort;
                request["Search"] = kywd;
                ...
                pagename = "/manajemen_transaksi/ajax_manajemen_transaksi_isi_saldo";
            ...
            $("#FrmFilter .status, #FrmFilter .sort, #FrmFilter .tanggal").change(function(){
                GetDataTable();
            });

            var manajemen_transaksi_isi_saldo_detail = $("#modal-detail-manajemen-transaksi-biaya-admin");
            $(".datatable-manajemen-transaksi-biaya-admin").on("click", ".detail-manajemen-transaksi-biaya-admin", function() {
                ...
                manajemen_transaksi_isi_saldo_detail.find(".loading-gif-image").removeClass("d-none");
                manajemen_transaksi_isi_saldo_detail.find(".after-loading").addClass("d-none");
                ...
                GetDataById(id_update, function(resp) {
                    ...
                    manajemen_transaksi_isi_saldo_detail.find(".nama-properti").text(resp.nama_properti);
                    manajemen_transaksi_isi_saldo_detail.find(".alamat").text(resp.alamat_properti);
                    manajemen_transaksi_isi_saldo_detail.find(".durasi-proyek").text(moment(resp.tgl_mulai).format("DD MMM YYYY")+" - "+moment(resp.tgl_selesai).format("DD MMM YYYY"));
                    manajemen_transaksi_isi_saldo_detail.find(".harga-saham").text("Rp "+rupiah(resp.harga_per_lembar));
                    manajemen_transaksi_isi_saldo_detail.find(".jumlah-saham").text("Rp "+rupiah(resp.jumlah_dana));
                    manajemen_transaksi_isi_saldo_detail.find(".dividen-period").text(resp.dividen_period);
                    manajemen_transaksi_isi_saldo_detail.find(".no-transaksi").text(resp.no_transaksi);
                    manajemen_transaksi_isi_saldo_detail.find(".tgl-transaksi").text(moment(resp.tgl_transaksi).format("DD MMM YYYY HH:mm:ss"));
                    manajemen_transaksi_isi_saldo_detail.find(".biaya-administrasi").text("Rp "+rupiah(resp.isi_saldoistrasi));
                    manajemen_transaksi_isi_saldo_detail.find(".total-pembayaran").text("Rp "+rupiah(resp.total_transaksi));
                    manajemen_transaksi_isi_saldo_detail.find(".loading-gif-image").addClass("d-none");
                    manajemen_transaksi_isi_saldo_detail.find(".after-loading").removeClass("d-none");
                    $("#modal-detail-manajemen-transaksi-biaya-admin .modal-title").text("Detail Transaksi : " + resp.no_transaksi);
                });
            });
            $(".btn-pdf").click(function(){
                var kywd = $("#FrmSearch").find(".kywd").val(), status = $("#FrmFilter").find(".status").val(), sort = $("#FrmFilter").find(".sort").val(), tanggal_periode = $("#FrmFilter").find(".tanggal").val();
                window.location.href = base_url + "/manajemen_transaksi/isi_saldo_cetak.html?sort="+sort+"&search="+kywd+"&status="+status+"&tanggal_mulai="+moment(tanggal_periode.slice(0, 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&tanggal_selesai="+moment(tanggal_periode.substr(tanggal_periode.length - 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&by="+"<?php echo $this->session->userdata("user")->nama; ?>";
            });
            $(".btn-excel").click(function(){
                var kywd = $("#FrmSearch").find(".kywd").val(), status = $("#FrmFilter").find(".status").val(), sort = $("#FrmFilter").find(".sort").val(), tanggal_periode = $("#FrmFilter").find(".tanggal").val();
                window.location.href = base_url + "/manajemen_transaksi/isi_saldo_excel.html?sort="+sort+"&search="+kywd+"&status="+status+"&tanggal_mulai="+moment(tanggal_periode.slice(0, 11), "DD MMM YYYY").format("YYYY-MM-DD")+"&tanggal_selesai="+moment(tanggal_periode.substr(tanggal_periode.length - 11), "DD MMM YYYY").format("YYYY-MM-DD");
            });
        </script>
    </body>
</html>
